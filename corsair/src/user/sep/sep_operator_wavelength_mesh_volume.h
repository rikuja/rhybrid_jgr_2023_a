...
#ifndef SEP_OPERATOR_WAVELENGTH_MESH_VOLUME_H
#define SEP_OPERATOR_WAVELENGTH_MESH_VOLUME_H
...
namespace sep {
   ...
   class WavelengthMeshVolumeOP: public SpatialSliceOP {
    public:
      WavelengthMeshVolumeOP();
      ~WavelengthMeshVolumeOP();
