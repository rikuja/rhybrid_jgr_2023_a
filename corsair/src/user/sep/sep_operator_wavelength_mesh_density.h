...
#ifndef SEP_OPERATOR_WAVELENGTH_MESH_DENSITY_H
#define SEP_OPERATOR_WAVELENGTH_MESH_DENSITY_H
...
namespace sep {
   ...
   class WavelengthMeshDensityOP: public SpatialSliceOP {
    public:
      WavelengthMeshDensityOP();
      ~WavelengthMeshDensityOP();
