...
#ifndef SEP_PARTICLE_BOUNDARY_COND_H
#define SEP_PARTICLE_BOUNDARY_COND_H
...
namespace sep {
   ...
   class ParticleBoundaryCond: public ParticleBoundaryCondBase {
    public: 
      ParticleBoundaryCond();
   ...
   ParticleBoundaryCondBase* PBCondMaker() {return new ParticleBoundaryCond<SPECIES,PARTICLE>();}

   template<class SPECIES,class PARTICLE> inline
   ParticleBoundaryCond<SPECIES,PARTICLE>::ParticleBoundaryCond(): ParticleBoundaryCondBase() { }
   
   template<class SPECIES,class PARTICLE> inline
   bool ParticleBoundaryCond<SPECIES,PARTICLE>::apply(pargrid::DataID particleDataID,unsigned int* N_particles,
   ...
   template<class SPECIES,class PARTICLE> inline
   bool ParticleBoundaryCond<SPECIES,PARTICLE>::initialize(Simulation& sim,SimulationClasses& simClasses,ConfigReader& cr,
							   const std::string& regionName,const ParticleListBase* plist) {
