...
#ifndef SEP_OPERATOR_ANISOTROPY_H
#define SEP_OPERATOR_ANISOTROPY_H
...
namespace sep {
   ...
   class OperatorAnisotropy: public OperatorAccumulationBase {
    public:
      OperatorAnisotropy(int32_t order=1);
      ~OperatorAnisotropy();
