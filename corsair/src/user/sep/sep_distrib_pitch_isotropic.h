...
#ifndef SEP_DISTRIB_PITCH_ISOTROPIC_H
#define SEP_DISTRIB_PITCH_ISOTROPIC_H
...
namespace sep {
   ...
   struct PitchDistribIsotropic {
      PitchDistribIsotropic();
      
      bool initialized;
      SimulationClasses* simClasses;
   };
   
   bool pitchDistribIsotropicFinalize();
